...
abstract class Annamalai_University
{
...
class SKCET extends Annamalai_University
{
	void Dep_Available()
	{
...
class SMVCET extends Annamalai_University
{
	void Dep_Available()
	{
...
class RGCET extends Annamalai_University
{
	void Dep_Available()
	{
...
class RCET extends Annamalai_University
{
	void Dep_Available()
	{
...
public class Department {
	...
	public static void main(String[] args) {
		System.out.println("WELCOME TO ANNAMALAI UNIVERSITY BOARD");
		...
		int n=Sc.nextInt();
		Annamalai_University obj1=new SKCET();
		Annamalai_University obj2=new SMVCET();
		Annamalai_University obj3=new RGCET();
		Annamalai_University obj4=new RCET();
		switch(n)
		{
		case 1: 
			obj1.Dep_Available();
